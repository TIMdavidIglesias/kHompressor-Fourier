window.addEventListener("DOMContentLoaded",() => {
	let ampliff = new RollCounterRange("#ampliff"),
  zeta = new RollCounterRange("#zeta"),
  At = new RollCounterRange("#At"),
  samplingDisplay = new RollCounterRange("#samplingDisplay"),
  STime = new RollCounterRange("#STime"),
  Wn = new RollCounterRange("#Wn");
});
